...
Student.create!(id:     8701, fname: 'Rick', lname: 'Grimes')
Student.create!(id:     8702, fname: 'Mary', lname: 'Hoppin')
Student.create!(id:     8703, fname: 'Kevin',lname: 'Edward')
Student.create!(id:     8704, fname: 'Gary', lname: 'Wood')
Student.create!(id:     8705, fname: 'Roy',  lname: 'Bailey')
Student.create!(id:     8706, fname: 'Lily', lname: 'Robin')
Student.create!(id:     8707, fname: 'Nyna', lname: 'Park')
Student.create!(id:     8708, fname: 'Lauren', lname: 'Clare')
Student.create!(id:     8709, fname: 'Carl', lname: 'Stallone')
Student.create!(id:     8710, fname: 'Clark', lname: 'Kent')
Student.create!(id:     4311, fname: 'lucifer', lname: 'Satan')
Student.create!(id:     4312, fname: 'Giovanni', lname: 'Luna')
Student.create!(id:     4313, fname: 'Kun', lname: 'Kim')
Student.create!(id:     4314, fname: 'Grigory', lname: 'Kashkin')
Student.create!(id:     4315, fname: 'Zhiguang', lname: 'Xu')
Student.create!(id:     4316, fname: 'Dave', lname: 'Gibson')
Student.create!(id:     4317, fname: 'Shet', lname: 'hitfan')
Student.create!(id:     4318, fname: 'Roger', lname: 'Willis')
Student.create!(id:     4319, fname: 'Susan', lname: 'Grim')
Student.create!(id:     4320, fname: 'Lois', lname: 'Lane')
